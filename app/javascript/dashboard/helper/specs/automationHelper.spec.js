...
describe('getOperatorTypes', () => {
  it('returns the correct custom attribute operators', () => {
    ...
    // Fork customization: text custom attributes get OPERATOR_TYPES_7 (adds
    // contains / does_not_contain / is_present / is_not_present) instead of
    // upstream's OPERATOR_TYPES_3.
