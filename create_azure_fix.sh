#!/bin/bash
# Script to create the Azure OpenAI fix file on your VPS
...
echo "✅ File created at: /opt/chatwoot-patches/enterprise/app/services/llm/base_open_ai_service.rb"
echo ""
echo "Next steps:"
echo "1. Update Coolify docker-compose to mount this file"
echo "2. Add volume: /opt/chatwoot-patches/enterprise/app/services/llm/base_open_ai_service.rb:/app/enterprise/app/services/llm/base_open_ai_service.rb:ro"
echo "3. Redeploy"
