...
echo ""
echo "💡 IMPORTANT: Add this environment variable in Coolify:"
echo "   Name: STAGING_PATCHES_DIR"
echo "   Value: ${STAGING_PATCHES_DIR}"
echo ""
echo "   Then update docker-compose to use: docker-compose.staging-simple.yaml"
