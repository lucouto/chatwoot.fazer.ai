class Llm::BaseOpenAiService
  ...
  def azure_embeddings(parameters)
    ...
    # Use separate API version for embeddings if configured, otherwise use chat API version
    embedding_api_version = InstallationConfig.find_by(name: 'CAPTAIN_EMBEDDING_API_VERSION')&.value || @azure_api_version
    ...
    url = "#{embeddings_endpoint}/embeddings?api-version=#{embedding_api_version}"
